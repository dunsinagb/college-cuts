...
export default function TalentRegister() {
  ...
  const [form, setForm] = useState<FormData>({
    name: "", email: "", institution: prefillInstitution, department: "",
    role_title: "", degree_level: "", years_experience: "", specializations: "",
        ...
        <div style={{ background: "linear-gradient(135deg, #1e3a5f 0%, #2a4e7c 100%)" }} className="py-14 px-4">
          <div className="container mx-auto max-w-3xl">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xs font-bold uppercase tracking-widest text-amber-300">Free · Takes 3 minutes</span>
            </div>
          ...
          <form onSubmit={handleSubmit}>
            <Card className="border-0 shadow-sm">
              <CardContent className="p-6 space-y-6">
                <h2 className="text-lg font-bold text-[#1e3a5f]">Your Background</h2>
